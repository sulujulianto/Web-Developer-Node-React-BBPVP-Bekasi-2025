...
- Deployment using **WHM & cPanel**

> 💡 *This training focused on a SQL-based alternative to the MERN stack — combining Node.js, Express, React, and MySQL (instead of MongoDB).*
...
This repository serves as a personal portfolio documenting my growth and hands-on learning throughout the **BBPVP Bekasi Web Development Training (Node.js, React.js, & MySQL)** — covering online sessions, on-site training, and the **On the Job Training (OJT)** phase, including website deployment using **WHM and cPanel**.
